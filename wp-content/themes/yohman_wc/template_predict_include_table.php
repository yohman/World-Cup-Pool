...
$counter = 1;
echo '<div id="debugwin" class="well" style="display:none;color:red;"></div>';
	...
	echo "<table class='' width='100%' style='border:1px solid red;'>";
...
while ( $loop->have_posts() ) : $loop->the_post(); 
	...
	// 	}
	// 	echo '<div style="text-align:center;"><h1>'.$day.'</h1></div>';
	// }
	// $day_check = $day;
	echo '<tr class="" style=""><td>';
	

	echo '<span id="matchdate-'.$post->ID.'"></span>';
	echo '</td>';
	...
	// show day
	echo "<td align='center'><span style='font-size:1em' id='match_day-".$post->ID."'></span> <span class='glyphicon glyphicon-calendar'></span> <span id='match_hour-".$post->ID."'></span></span></td>";
	...
	*/
	...
	echo "<img data-toggle='tooltip' title='".$team1_name."' src='".get_stylesheet_directory_uri()."/images/flags/shiny/64/".$team1_name.".png' style='vertical-align:middle'><br>".$team1_name."</td>";
	// prediction scores
	echo "<td align='center'>
	...
	if (get_current_user_id() == 0)
	{
		...
		<?php
		echo "<button class='btn btn-danger disabled'>login</button></a>";
	...
	else
	{
		...
		{
			echo "<button class='btn btn-warning' onclick=\"yohman.launchPredictionModal('".$post->ID."','".$team1_name."','".$team2_name."','".$prediction_team1score."','".$prediction_team2score."')\"><span class='glyphicon glyphicon-pencil'></span> predict</button>";
		}
		else
		{
	...
	// flag team 2
	echo "<td align='center'><img data-toggle='tooltip' title='".$team2_name."' src='".get_stylesheet_directory_uri()."/images/flags/shiny/64/".$team2_name.".png' style='vertical-align:middle'>".$team2_name;
	echo "</td>";
...
<!-- 	<div class="row">
	...
	if ($thismatchdate2<$now2)
	{
		...
		{
			$resultcolor = '#343';
			$resulticon = '<img src="https://cdn0.iconfinder.com/data/icons/popo_emotions_the_blacy_png/128/what.png">';
			$resultsmsg = '<br>shhhhh... yohda is busy (probably watching this match on tape delay... Don\'t tell him the score!)';
		}
		else
		{
			...
			{
				$resultcolor = '#555';
				$resulticon = '<img src="https://cdn1.iconfinder.com/data/icons/popo_emotions_the_blacy_png/128/money.png" width="80">';
				$resultsmsg = '+3 Dompisha!<br>';
			}
			...
			{
				$resultcolor = '#555';
				$resulticon = '<img src="https://cdn0.iconfinder.com/data/icons/popo_emotions_the_blacy_png/128/victory.png" width="80">';
				$resultsmsg = '+1 Right winner!<br>';				
			}
			elseif($prediction_team1score == $prediction_team2score && $team1score_customfield != '' &&  $team2score_customfield !='' && $team1score_customfield == $team2score_customfield)
			{
				$resultcolor = '#555';
				$resulticon = '<img src="https://cdn0.iconfinder.com/data/icons/popo_emotions_the_blacy_png/128/victory.png" width="80">';
				$resultsmsg = '+1 You guessed a tie!<br>';				
			}
			else
			{
				$resultcolor = '#555';
				$resulticon = '<img src="https://cdn0.iconfinder.com/data/icons/popo_emotions_the_blacy_png/128/cry.png" width="80">';
				$resultsmsg = '+0 You guessed wrong!<br>';				
			}

			$results = 'Final score: '.$team1_name.' <span style="font-size:2em;">'.$team1score_customfield.'</span> - '.$team2_name.' <span style="font-size:2em;">'.$team2score_customfield.'</span>';
		}
		// echo '<div class="row"><div class="" style="background:'.$resultcolor.';padding:10px;">'.$resultsmsg.'</div></div>';
		echo '<td>'.$results.'</td><td style="background:'.$resultcolor.';">'.$resulticon.'</td>';						
	}
	else
	{
		echo "<td align='center'>aaa</td>";
		echo "<td align='center'>(final score)</td>";
	}
