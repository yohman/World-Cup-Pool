...
while ( $loop->have_posts() ) : $loop->the_post(); 
	...
	*/
	...
	if ($thismatchdate2<$now2)
	{
		...
		echo '<table class="table" style="background:'.$resultcolor.';"><tr><td>'.$resulticon.'</td><td>'.$results.'<br>'.$resultsmsg.'</td></tr></table>';						
	}
	...
	<a href="<?php the_permalink();?>">
		<button type="button" class="btn btn-default btn-xs">
			user predictions|ユーザー予想 <span class="glyphicon glyphicon-arrow-right"></span>
		</button>
	</a>
	<?php
